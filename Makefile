...
arduino_secrets:
	...
	@echo "//Der Benutzername für Ihre Fritzbox. Wenn Sie keine separaten Benutzer angelegt haben, lautet dieser \"admin\"." >> $(OUTPUT)
	@echo "#define SECRET_FUSER \"$(SECRET_FUSER)\"" >> $(OUTPUT)
	@echo " //Das Passwort für Ihre Fritzbox" >> $(OUTPUT)
	@echo "#define SECRET_PASS \"$(SECRET_FPASS)\"" >> $(OUTPUT)
	@echo "//Die IP-Adresse Ihrer Fritzbox. Ab Werk lautet diese 192.168.178.1." >> $(OUTPUT)
